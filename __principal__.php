...
<head>
    ...
    <style>
        ...
        .sidebar a, .sidebar button.accordion-button { color: #fff; text-decoration: none; display: flex; align-items: center; padding: 0.3rem 0.8rem; border-radius: 5px; margin: 0.1rem 0; white-space: nowrap; font-size: 0.9rem; }
...
<div class="content">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-2 mb-2">
            <a href="boleto/listar.php" class="text-decoration-none">
        ...
        <div class="col-md-2 mb-2">
            <a href="boleto/listar.php" class="text-decoration-none">
                <div class="card card-small border-0 shadow-sm text-white bg-success">
                    <div class="card-body">
                        <h5>Boletos pagos</h5>
                        <h2><?= $totais_boletos['pago'] ?></h2>
                        <canvas id="miniChartBoletosPagos" class="card-mini-chart mt-1"></canvas>
                    </div>
                </div>
            </a>
        </div>
        ...
        <!-- Pedidos não pagos -->
        <div class="col-md-2 mb-2">
            <a href="pedido/listar.php" class="text-decoration-none">
        ...
        <div class="col-md-2 mb-2">
            <a href="pedido/listar.php" class="text-decoration-none">
                <div class="card card-small border-0 shadow-sm text-white bg-success">
                    <div class="card-body">
                        <h5>Pedidos pagos</h5>
                        <h2><?= $totais_pedidos['pago'] ?></h2>
                        <canvas id="miniChartPedidosPagos" class="card-mini-chart mt-1"></canvas>
                    </div>
                </div>
            </a>
        </div>
...
gerarMiniChart('miniChartBoletosPagos', <?= json_encode($dados_boletos_dia) ?>);
gerarMiniChart('miniChartPedidos', <?= json_encode($dados_pedidos_dia) ?>);
gerarMiniChart('miniChartPedidosPagos', <?= json_encode($dados_pedidos_dia) ?>);
gerarMiniChart('miniChartComissao', <?= json_encode($dados_pedidos_dia) ?>);
</script>
